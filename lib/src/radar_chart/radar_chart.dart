...
/// A chart type which plots the values in the form of a spider web or radar. It takes the
/// `@required` [values] parameter which provides the data points `(minimum 3 values are required)`
...
/// Defaults to `true`.
///
/// [animationDuration] defines the duration (in milliseconds) of the animation for the graph.
